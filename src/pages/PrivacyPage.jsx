...
const PrivacyPage = () => {
    return (
        <Page className="h-auto min-h-screen bg-privacyVertical lg:bg-privacyHorizontal bg-cover bg-center bg-no-repeat flex flex-col items-center px-6 lg:px-16">

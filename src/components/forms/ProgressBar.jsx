...
const ProgressBar = ({ progress }) => {
    return (
        <div className="flex fixed top-12 p-12 pb-24 w-full max-w-7xl bg-gradient-to-b from-background via-background to-transparent duration-300 ease-in-out pointer-events-none">
